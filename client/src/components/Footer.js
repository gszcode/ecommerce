          ...
          <div className="row align-items-center">
            <div className="col-5">
              <div className="footer-top-data d-flex gap-30 align-items-center">
                ...
                <h2 className="mb-0 text-white">Sign Up for Newssletter</h2>
              </div>
            </div>
            <div className="col-7">
            ...
            <div className="col-4">
              ...
              <div>
                <address className="text-white fs-6">
                  BsAs: 2023 R. Argentina, <br /> Capital Federal <br />
                  PinCode: 2023
                </address>
                <a
                  href="tel:+54 1212343321"
                  className="mt-3 d-block mb-2 text-white"
                >
                  +54 1212343321
                </a>
                <a
                  href="mailto:shopping@gmail.com"
          ...
          <div className="row">
            <div className="col-12">
              <p className="text-center mb-0 text-white">
                &copy; {new Date().getFullYear()}; Powered by DevGszcode
              </p>
            </div>
          </div>
        </div>
