...
function Home() {
  return (
    <>
      ...
      <section className="featured-wrapper home-wrapper py-5">
        <div className="container-xxl">
          <div className="row">
            <div className="col-12">
      ...
      <section className="special-wrapper home-wrapper py-5">
        <div className="container-xxl">
          <div className="row">
            <div className="col-12">
      ...
      <section className="popular-wrapper home-wrapper py-5">
        <div className="container-xxl">
          <div className="row">
            <div className="col-12">
      ...
      <section className="marque-wrapper home-wrapper-2 p-5">
        <div className="container-xxl">
          <div className="row">
            <div className="col-12">
